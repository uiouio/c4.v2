		...
		public void PrintMorningCheckInfo(DataSet dsMorningCheckInfo,string getBegDate,string getEndDate,string savePath)
		{
			...
			{	
				...
				if ( dsMorningCheckInfo.Tables[0].Rows.Count > 0 )
				{
                    ...
                    m_objRange = m_objSheet.get_Range((Excel.Range)m_objSheet.Cells[dsMorningCheckInfo.Tables[0].Rows.Count + 4, 2], (Excel.Range)m_objSheet.Cells[dsMorningCheckInfo.Tables[0].Rows.Count + 4, 2]);
                    ...
                    m_objRange = m_objSheet.get_Range((Excel.Range)m_objSheet.Cells[dsMorningCheckInfo.Tables[0].Rows.Count + 4, 3], (Excel.Range)m_objSheet.Cells[dsMorningCheckInfo.Tables[0].Rows.Count + 4, 3]);
					m_objRange.Value = new GardenInfoDataAccess().GetGardenInfo().Tables[0].Rows[0][1].ToString();
					m_objRange.Font.Size = 12;
					m_objRange.HorizontalAlignment = Excel.XlHAlign.xlHAlignLeft;
					m_objRange.VerticalAlignment = Excel.XlHAlign.xlHAlignCenter;

                    m_objRange = m_objSheet.get_Range((Excel.Range)m_objSheet.Cells[dsMorningCheckInfo.Tables[0].Rows.Count + 5, 2], (Excel.Range)m_objSheet.Cells[dsMorningCheckInfo.Tables[0].Rows.Count + 5, 2]);
                    ...
                    m_objRange = m_objSheet.get_Range((Excel.Range)m_objSheet.Cells[dsMorningCheckInfo.Tables[0].Rows.Count + 5, 3], (Excel.Range)m_objSheet.Cells[dsMorningCheckInfo.Tables[0].Rows.Count + 5, 3]);
		...
		public void PrintBackCheckInfo(DataSet dsBackCheckInfo,string getBegDate,string getEndDate,string savePath)
		{
			try
			{
				...
				if ( dsBackCheckInfo.Tables[0].Rows.Count > 0 )
				{
                    ...
                    m_objRange = m_objSheet.get_Range((Excel.Range)m_objSheet.Cells[dsBackCheckInfo.Tables[0].Rows.Count + 4, 2], (Excel.Range)m_objSheet.Cells[dsBackCheckInfo.Tables[0].Rows.Count + 4, 2]);
					m_objRange.Value = "园所信息:";
					m_objRange.Font.Bold = true;
					m_objRange.Font.Size = 12;
					m_objRange.HorizontalAlignment = Excel.XlHAlign.xlHAlignLeft;
                    ...
                    m_objRange = m_objSheet.get_Range((Excel.Range)m_objSheet.Cells[dsBackCheckInfo.Tables[0].Rows.Count + 4, 3], (Excel.Range)m_objSheet.Cells[dsBackCheckInfo.Tables[0].Rows.Count + 4, 3]);
					m_objRange.Value = new GardenInfoDataAccess().GetGardenInfo().Tables[0].Rows[0][1].ToString();
					m_objRange.Font.Size = 12;
					m_objRange.HorizontalAlignment = Excel.XlHAlign.xlHAlignLeft;
					m_objRange.VerticalAlignment = Excel.XlHAlign.xlHAlignCenter;

                    m_objRange = m_objSheet.get_Range((Excel.Range)m_objSheet.Cells[dsBackCheckInfo.Tables[0].Rows.Count + 5, 2], (Excel.Range)m_objSheet.Cells[dsBackCheckInfo.Tables[0].Rows.Count + 5, 2]);
					m_objRange.Value = "统计日期:";
					m_objRange.Font.Bold = true;
					m_objRange.Font.Size = 12;
					m_objRange.HorizontalAlignment = Excel.XlHAlign.xlHAlignLeft;
                    ...
                    m_objRange = m_objSheet.get_Range((Excel.Range)m_objSheet.Cells[dsBackCheckInfo.Tables[0].Rows.Count + 5, 3], (Excel.Range)m_objSheet.Cells[dsBackCheckInfo.Tables[0].Rows.Count + 5, 3]);
					m_objRange.Value = Convert.ToDateTime(getBegDate).ToString("yyyy.MM.dd")+" -- "+Convert.ToDateTime(getEndDate).ToString("yyyy.MM.dd");
					m_objRange.Font.Size = 12;
					m_objRange.HorizontalAlignment = Excel.XlHAlign.xlHAlignLeft;
					m_objRange.VerticalAlignment = Excel.XlHAlign.xlHAlignCenter;
			...
			try
			{
				...
				for ( int row = 0; row < dsBuildStatInfo.Tables[0].Rows.Count; row ++ )
				{
					...
					if ( row == dsBuildStatInfo.Tables[0].Rows.Count - 1 )
					{
                        ...
                        m_objRange = m_objSheet.get_Range((Excel.Range)m_objSheet.Cells[row + 11, 1], (Excel.Range)m_objSheet.Cells[row + 11, 1]);
                        ...
                        m_objRange = m_objSheet.get_Range((Excel.Range)m_objSheet.Cells[row + 11, 2], (Excel.Range)m_objSheet.Cells[row + 11, 2]);
						m_objRange.Value = EndDate.ToString("yyyy-MM-dd");
						m_objRange.Font.Size = 12;
						m_objRange.HorizontalAlignment = Excel.XlHAlign.xlHAlignLeft;
						m_objRange.VerticalAlignment = Excel.XlHAlign.xlHAlignCenter;

                        m_objRange = m_objSheet.get_Range((Excel.Range)m_objSheet.Cells[row + 12, 1], (Excel.Range)m_objSheet.Cells[row + 12, 1]);
                        ...
                        m_objRange = m_objSheet.get_Range((Excel.Range)m_objSheet.Cells[row + 12, 2], (Excel.Range)m_objSheet.Cells[row + 12, 2]);
...
//							}
		...
		{
            m_objRange = m_objSheet.get_Range((Excel.Range)m_objSheet.Cells[row + 5, 1], (Excel.Range)m_objSheet.Cells[row + 5, 1]);
			m_objRange.Value = "园所信息:";
			m_objRange.Font.Bold = true;
			m_objRange.Font.Size = 12;
			m_objRange.HorizontalAlignment = Excel.XlHAlign.xlHAlignLeft;
            ...
            m_objRange = m_objSheet.get_Range((Excel.Range)m_objSheet.Cells[row + 5, 2], (Excel.Range)m_objSheet.Cells[row + 5, 2]);
			m_objRange.Value = new GardenInfoDataAccess().GetGardenInfo().Tables[0].Rows[0][1].ToString();
			m_objRange.Font.Size = 12;
			m_objRange.HorizontalAlignment = Excel.XlHAlign.xlHAlignLeft;
			m_objRange.VerticalAlignment = Excel.XlHAlign.xlHAlignCenter;

            m_objRange = m_objSheet.get_Range((Excel.Range)m_objSheet.Cells[row + 6, 1], (Excel.Range)m_objSheet.Cells[row + 6, 1]);
            ...
            m_objRange = m_objSheet.get_Range((Excel.Range)m_objSheet.Cells[row + 6, 2], (Excel.Range)m_objSheet.Cells[row + 6, 2]);
			m_objRange.Value = classInfo;
			m_objRange.Font.Size = 12;
			m_objRange.HorizontalAlignment = Excel.XlHAlign.xlHAlignLeft;
			m_objRange.VerticalAlignment = Excel.XlHAlign.xlHAlignCenter;
            ...
            m_objRange = m_objSheet.get_Range((Excel.Range)m_objSheet.Cells[row + 7, 2], (Excel.Range)m_objSheet.Cells[row + 7, 2]);
			m_objRange.Value = Convert.ToDateTime(getBegDate).ToString("yyyy.MM.dd")+" -- "+Convert.ToDateTime(getEndDate).ToString("yyyy.MM.dd");
			m_objRange.Font.Size = 12;
			m_objRange.HorizontalAlignment = Excel.XlHAlign.xlHAlignLeft;
			m_objRange.VerticalAlignment = Excel.XlHAlign.xlHAlignCenter;
