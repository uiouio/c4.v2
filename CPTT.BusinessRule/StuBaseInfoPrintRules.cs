	...
	public class StuBaseInfoPrintRules :IDisposable
	{
		...
		public void AllStuInfoPrint(DataSet dsExportData,string savePath)
		{
			try
			{
                ...
                {
                    dsExportData.Tables[0].Rows.Add(new object[] { "", 1, 1, Convert.ToString(dsExportData.Tables[1].Rows[row - 1][0]), "", "2001-1-1", "", "", "", "", "", "" });
                }
		...
		private void BindingData(string className)
		{
			...
			m_objRange = m_objRange.get_Resize(dv.Count - 1,9);
