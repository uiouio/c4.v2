	...
	public class RealtimeInfoStat_TeacherPrintRules
	{
		...
		public void RealtimeMorningPrint(DataSet dsRealtimeInfoStat_Teacher,string savePath)
		{
			...
			try
			{
                ...
                m_objRange = m_objSheet.get_Range((Excel.Range)m_objSheet.Cells[dsRealtimeInfoStat_Teacher.Tables[0].Rows.Count + 8, 1], (Excel.Range)m_objSheet.Cells[dsRealtimeInfoStat_Teacher.Tables[0].Rows.Count + 8, 1]);
                ...
                m_objRange = m_objSheet.get_Range((Excel.Range)m_objSheet.Cells[dsRealtimeInfoStat_Teacher.Tables[0].Rows.Count + 8, 2], (Excel.Range)m_objSheet.Cells[dsRealtimeInfoStat_Teacher.Tables[0].Rows.Count + 8, 3]);
                ...
                m_objRange = m_objSheet.get_Range((Excel.Range)m_objSheet.Cells[dsRealtimeInfoStat_Teacher.Tables[0].Rows.Count + 9, 1], (Excel.Range)m_objSheet.Cells[dsRealtimeInfoStat_Teacher.Tables[0].Rows.Count + 9, 1]);
                ...
                m_objRange = m_objSheet.get_Range((Excel.Range)m_objSheet.Cells[dsRealtimeInfoStat_Teacher.Tables[0].Rows.Count + 9, 2], (Excel.Range)m_objSheet.Cells[dsRealtimeInfoStat_Teacher.Tables[0].Rows.Count + 9, 3]);
				m_objRange.MergeCells = true;
