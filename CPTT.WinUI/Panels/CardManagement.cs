	...
	public class CardManagement : DevExpress.XtraEditors.XtraUserControl
	{
		...
		private void DisplayCardInfo(DataSet cardDetails)
		{
			...
			if(searchStu)
			{
				...
				SendCard1Holder.Text = string.Empty;
					...
					foreach(DataRow row in cardDetails.Tables[0].Rows)
					{
						...
						switch(cardSeq)
						{
							case 1:
								...
								SendCard1Holder.Text = row["info_stuCardHolder"].ToString();
							...
							case 2:
								...
								SendCard2Holder.Text = row["info_stuCardHolder"].ToString();
							...
							case 3:
								...
								SendCard3Holder.Text = row["info_stuCardHolder"].ToString();
							...
							case 4:
								...
								SendCard4Holder.Text = row["info_stuCardHolder"].ToString();
							...
							case 5:
								...
								SendCard5Holder.Text = row["info_stuCardHolder"].ToString();
		...
		private void Timer_SendCardOverTime_Elapsed(object sender, System.Timers.ElapsedEventArgs e)
		{
			...
			if(reTryTime<5)//ÖØÊÔ5´Î
			{
				...
				catch(Exception ex)
				{
					...
					{
						LoginForm.sendCardThread = new Thread(LogoutCard);
					}
