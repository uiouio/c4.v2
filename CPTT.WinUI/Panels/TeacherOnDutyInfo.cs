...
namespace CPTT.WinUI.Panels
{
	...
	public class TeacherOnDutyInfo : DevExpress.XtraEditors.XtraUserControl
	{
		...
		{
            //if(zedGraphControl_TeaDuty==null)
            //{
            //    MessageBox.Show("请先生成报表.","系统信息!",MessageBoxButtons.OK,
            ...
            //g.DrawImage(zedGraphControl_TeaDuty.GraphPane.Image,
            //    new Rectangle(50,50,zedGraphControl_TeaDuty.GraphPane.Image.Width,
            //    zedGraphControl_TeaDuty.GraphPane.Image.Height),DevExpress.XtraPrinting.BorderSide.All,
            //    Color.LightGray);
