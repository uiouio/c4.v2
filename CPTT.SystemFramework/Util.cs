...
namespace CPTT.SystemFramework
{
	...
	public class Util
	{
		...
		#region 版本信息
		public const string PROJECT_VERSION = "4.33.1.8u";
			...
			if (data.Rows.Count > 0)
			{
				...
				foreach(DataRow dr in data.Rows)
				{
					try
					{
						...
						ddfdf = string.Format("key={0}&school_id={1}&class_id={2}&student_id={3}&check_type={4}&md5={5}",
					...
					{
						SystemFramework.Util.WriteLog(ddfdf, SystemFramework.Util.EXCEPTION_LOG_TITLE);
					}
				}
			}
		}
