...
namespace CPTT.BusinessFacade
{
	...
	public class UtilSystem
	{
		...
		public void AddUniqueGardenStatus(string gardenName, string gardenID)
		{
			new UtilDataAccess().AddUniqueStatus(gardenName, string.IsNullOrEmpty(gardenID) ? Guid.NewGuid().ToString() : gardenID);
		}
	}
}
